"""Standalone script to execute live Pydantic AI calls against muse-glimmer on Ollama."""
...
def main():
    print("=" * 70)
    print("GxPSoft — Live Pydantic AI Execution on Local Ollama (muse-glimmer)")
    print("=" * 70)

    # 1. Check Ollama server
    online = is_ollama_online()
    model = get_agent_model()
    print(f"Ollama Server Online: {online}")
    ...
    print("\n" + "-" * 70)
    print("STEP 1: Autonomous Triage & Multi-System RCA via Pydantic AI")
    print("-" * 70)
    ...
    print("\n" + "-" * 70)
    print("STEP 2: Human-in-the-Loop Part 11 Electronic Signatures")
    print("-" * 70)
    ...
    print("\n" + "-" * 70)
    print("STEP 3: Autonomous CAPA Plan Generation via Pydantic AI")
    print("-" * 70)
    ...
    print("\n" + "-" * 70)
    print("STEP 4: 21 CFR Part 11 Cryptographic Audit Trail Verification")
    print("-" * 70)
    ...
    print("=" * 70)
    print("SUCCESS: Full Pydantic AI + muse-glimmer + Part 11 lifecycle verified!")
    print("=" * 70)
